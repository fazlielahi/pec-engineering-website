                        ...
                        <div class="modal-content">
                            ...
                            <div class="comments-list m-2" id="show-comments-{{ $blog->id }}" style="display: none;">
                                ...
                                <div class="mb-3 p-3 border rounded">
                                    ...
                                    <p class="mb-0" style="padding: 2px 42px !important;"> {{ $comment->comment }}</p>
                                </div>
                                @endforeach
...
$(document).ready(function() {
    ...
    $(document).on('click', '.show-blogs', function(e) {
        ...
        // Show loading state
        $('#user-profile-container').html('<div class="text-center my-5"><i class="fa fa-spinner fa-spin fa-2x"></i><p class="mt-2">جاري تحميل مدونات المستخدم</p></div>');
